    ...
    return (
      <div className="betfoldaction-betfoldaction-3">
              ...
              <div className="betfoldaction-0-0">
                  <div className="betfoldaction-0-0-0">
                      <div className="betfoldaction-slider-5">
                          <input type="range" min={0} max={String(this.props.max)} value={String(this.props.value)} onChange={this.props.handleSliderChange} className="betfoldaction-slider-5" step="5" />
                      </div>
                  </div>
              </div>
          ...
          <div className="betfoldaction-1">
              <div className="betfoldaction-follow_button-8">
                  <Followbutton amount={this.props.min} betAction={this.props.betAction} /> 
              </div>
